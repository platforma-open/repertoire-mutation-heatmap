...
export type RepertoireMutationHeatmapBlockContract = BlockContract;
export type RepertoireMutationHeatmapBlockOutputs  = BlockOutputs;
export type RepertoireMutationHeatmapBlockData     = BlockData;
export const RepertoireMutationHeatmapBlockPointer = BlockPointer;
